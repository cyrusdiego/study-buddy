...
module OpenAiApi
    ...
    def fetch_questions content
        fetch_question_set content
    end
    module_function :fetch_questions

    def fetch_questions_array content_array
        content_array.each{ |content| question_sets.append(fetch_question_set content) }
    end
    module_function :fetch_questions_array
    ...
    private
        def fetch_question_set content
            ...
            OpenAiClient.instance.client.completions(
